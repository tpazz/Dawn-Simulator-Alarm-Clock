...
Adafruit_HX8357::Adafruit_HX8357(int8_t cs, int8_t dc, int8_t mosi,
  int8_t sclk, int8_t rst, int8_t miso, uint8_t type) : Adafruit_SPITFT(
  HX8357_TFTWIDTH, HX8357_TFTHEIGHT, cs, dc, mosi, sclk, rst, miso),
  displayType(type) {
}
...
static const uint8_t PROGMEM
  initb[] = {
    ...
    HX8357_MADCTL, 1,
      0x88, // modified (from 0xC0) for unPhone spin 4+
    HX8357_COLMOD, 1,
      0x55,
    HX8357_PASET, 4,
      0x00, 0x00, 0x01, 0xDF,
